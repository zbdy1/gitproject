...
public class TestSuperMom {
	...
	public static void login(){
		...
		boolean post=true;
		list.add(new BasicNameValuePair("phone","15500000000"));
		list.add(new BasicNameValuePair("password",MD5.getMD5ofStr("111111")));
	...
	private static void ask() {
		...
		list.add(new BasicNameValuePair("age","一岁半"));
	...
	private static void searchProductList() {
		List<NameValuePair> list=new ArrayList<NameValuePair>();
		boolean post=true;
		list.add(new BasicNameValuePair("key","保湿"));
		list.add(new BasicNameValuePair("page_size","1"));
		list.add(new BasicNameValuePair("page","1"));
