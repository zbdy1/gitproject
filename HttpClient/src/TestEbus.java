...
public class TestEbus {
	//	public static String url_base="http://115.28.180.91:9080/ellassy/";
	//public static String url_base="http://127.0.0.1:8080/ellassy/";
	public static String url_base="http://106.37.191.116:9080/ellassy/";
	public static void login(){
		List<NameValuePair> list=new ArrayList<NameValuePair>();
		boolean post=true;
		list.add(new BasicNameValuePair("phone","15511131111"));
	...
	public static void register(){
		...
		list.add(new BasicNameValuePair("sponsor","73"));
	...
	public static void introduction(){
		List<NameValuePair> list=new ArrayList<NameValuePair>();
		boolean post=true;
		list.add(new BasicNameValuePair("rank_id","2"));
	...
	public static void addAddr(){
		...
		boolean post=true;
		list.add(new BasicNameValuePair("member_id","3"));
		list.add(new BasicNameValuePair("addr","天堂路19号B栋"));
		list.add(new BasicNameValuePair("consignee","七仙女"));
	...
	public static void updateAddr(){
		...
		list.add(new BasicNameValuePair("addr","天堂路19号B栋5654号"));
		list.add(new BasicNameValuePair("consignee","七仙女"));
		list.add(new BasicNameValuePair("phone","12311231345"));
	...
	public static void update(){
		...
		boolean post=true;
		list.add(new BasicNameValuePair("member_id","3"));
		list.add(new BasicNameValuePair("nick_name","测试用户"));
	...
	public static void ecoupon(){
		List<NameValuePair> list=new ArrayList<NameValuePair>();
		boolean post=true;
		list.add(new BasicNameValuePair("member_id","507"));
		list.add(new BasicNameValuePair("type","0"));
		RequestRunnable run=new RequestRunnable(url_base+"account/ecoupon",list,post);
		HashMap<String,String> header=new HashMap<String,String>();
		header.put("token", "40DE5E6B1FA043E230230A94D29F4B99");
	...
	private static void advise() {
		List<NameValuePair> list=new ArrayList<NameValuePair>();
		boolean post=true;
		list.add(new BasicNameValuePair("content","今天吃饭吃的特别多"));
	...
	private static void topicDetails() {
		List<NameValuePair> list=new ArrayList<NameValuePair>();
		list.add(new BasicNameValuePair("topic_id","90"));
		boolean post=true;
	...
	private static void todayTopic() {
		List<NameValuePair> list=new ArrayList<NameValuePair>();
		boolean post=true;
		//list.add(new BasicNameValuePair("id","88"));
		list.add(new BasicNameValuePair("page_size","10"));
		new Thread(new RequestRunnable(url_base+"topic/todayTopic",list,post)).start();
	}
	private static void topicRelated() {
		List<NameValuePair> list=new ArrayList<NameValuePair>();
		boolean post=true;
		list.add(new BasicNameValuePair("topic_id","90"));
		new Thread(new RequestRunnable(url_base+"topic/topicRelated",list,post)).start();
	}
	...
	private static void comment() {
		...
		boolean post=true;
		list.add(new BasicNameValuePair("topic_id","1"));
		list.add(new BasicNameValuePair("content","再试一次"));
		list.add(new BasicNameValuePair("member_id","1"));
	...
	private static void questionDetails() {
		...
		new Thread(new RequestRunnable(url_base+"customMade/questionDetails",list,post)).start();
	}
	...
	private static void articleList() {
		List<NameValuePair> list=new ArrayList<NameValuePair>();
		boolean post=true;
		list.add(new BasicNameValuePair("teacher_id","46"));
	...
	private static void ask() {
		...
		boolean post=true;
		list.add(new BasicNameValuePair("member_id","3"));
		list.add(new BasicNameValuePair("title","如何保持年轻"));
		list.add(new BasicNameValuePair("description","如何能长久的保持年轻"));
	...
	private static void searchVideo() {
		List<NameValuePair> list=new ArrayList<NameValuePair>();
		list.add(new BasicNameValuePair("key","了"));
		boolean post=true;
	...
	private static void customMade_ask() {
		...
		boolean post=true;
		list.add(new BasicNameValuePair("member_id","3"));
		list.add(new BasicNameValuePair("title","如何保持快乐"));
		list.add(new BasicNameValuePair("description","如何能保证人生的幸福"));
	...
	private static void orderDetails() {
		List<NameValuePair> list=new ArrayList<NameValuePair>();
		boolean post=true;
		list.add(new BasicNameValuePair("order_id","922"));	
		RequestRunnable run=new RequestRunnable(url_base+"product/orderDetails",list,post);
		HashMap<String,String> header=new HashMap<String,String>();
		header.put("token", "43031324B512C6D1325451213673400C");
		run.setHeader(header);
		new Thread(run).start();
	}
	private static void pay() {
		List<NameValuePair> list=new ArrayList<NameValuePair>();
		boolean post=true;
		list.add(new BasicNameValuePair("order_id","15"));	
		list.add(new BasicNameValuePair("member_id","3"));	
		list.add(new BasicNameValuePair("addr_id","19"));
	...
	private static void addGoodsCart() {
		...
		boolean post=true;
		list.add(new BasicNameValuePair("member_id","507"));	
		list.add(new BasicNameValuePair("goods_id","239"));
		list.add(new BasicNameValuePair("num","2"));
		
		HashMap<String,String> header=new HashMap<String,String>();
		header.put("token", "943C9917B628BC583FA65D88CB4FE1EB");
		RequestRunnable run=new RequestRunnable(url_base+"goodsCart/addGoods",list,post);
		run.setHeader(header);
		new Thread(run).start();
	}
	private static void goodsList() {
		...
		HashMap<String,String> header=new HashMap<String,String>();
		header.put("token", "943C9917B628BC583FA65D88CB4FE1EB");
		RequestRunnable run=new RequestRunnable(url_base+"goodsCart/goodsList",list,post);
		run.setHeader(header);
	...
	private static void goodpoint() {
		...
		new Thread(new RequestRunnable(url_base+"topic/goodpoint",list,post)).start();
	}
	...
	private static void membershipDetails() {
		List<NameValuePair> list=new ArrayList<NameValuePair>();
		boolean post=true;
		list.add(new BasicNameValuePair("membership_id","1"));
	...
	private static void payMembership() {
		...
		list.add(new BasicNameValuePair("membership_id","1"));
		list.add(new BasicNameValuePair("member_id","3"));
		list.add(new BasicNameValuePair("order_id","311"));
		list.add(new BasicNameValuePair("addr_id","25"));
	...
	private static void reply() {
		...
		boolean post=true;
		list.add(new BasicNameValuePair("member_id","3"));
		list.add(new BasicNameValuePair("content","老师您在吗?"));
		list.add(new BasicNameValuePair("ask_id","6"));
		new Thread(new RequestRunnable(url_base+"customMade/reply",list,post)).start();
	}
	private static void custom_comment() {
		List<NameValuePair> list=new ArrayList<NameValuePair>();
		boolean post=true;
		list.add(new BasicNameValuePair("member_id","3"));
		list.add(new BasicNameValuePair("content","谢谢老师"));
		list.add(new BasicNameValuePair("ask_id","6"));
	...
	private static void myAskDetails() {
		List<NameValuePair> list=new ArrayList<NameValuePair>();
		boolean post=true;
		list.add(new BasicNameValuePair("ask_id","92"));
		new Thread(new RequestRunnable(url_base+"teacher/myAskDetails",list,post)).start();
	}
	...
	private static void topic_sharing() {
		...
		boolean post=true;
		list.add(new BasicNameValuePair("member_id","507"));
		list.add(new BasicNameValuePair("topic_id","10"));	
		//EBF6A5400EAF3121A92A38A9A18D05D7
		RequestRunnable run=new RequestRunnable(url_base+"topic/sharing",list,post);
		HashMap<String,String> header=new HashMap<String,String>();
		header.put("token", "40DE5E6B1FA043E230230A94D29F4B99");
		run.setHeader(header);
		new Thread(run).start();
	...
	private static void allArticleList() {
		List<NameValuePair> list=new ArrayList<NameValuePair>();
		boolean post=true;
		list.add(new BasicNameValuePair("teacher_id","50"));
		new Thread(new RequestRunnable(url_base+"teacher/allArticleList",list,post)).start();
	}
	private static void activityList() {
		List<NameValuePair> list=new ArrayList<NameValuePair>();
		boolean post=true;
		//list.add(new BasicNameValuePair("teacher_id","50"));
		new Thread(new RequestRunnable(url_base+"activity/activityList",list,post)).start();
	}
	private static void activityDetails() {
		List<NameValuePair> list=new ArrayList<NameValuePair>();
		boolean post=true;
		list.add(new BasicNameValuePair("activity_id","2"));
		new Thread(new RequestRunnable(url_base+"activity/activityDetails",list,post)).start();
	}
	private static void activity_reply() {
		List<NameValuePair> list=new ArrayList<NameValuePair>();
		boolean post=true;
		list.add(new BasicNameValuePair("activity_id","2"));
		list.add(new BasicNameValuePair("content","平 时吃饭吃的太多会出什么问题?"));
		list.add(new BasicNameValuePair("member_id","3"));
		new Thread(new RequestRunnable(url_base+"activity/reply",list,post)).start();
	}
